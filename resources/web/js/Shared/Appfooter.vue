  ...
  <footer class="bg-gray-800 text-gray-100">
    ...
    >
      <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
        ...
        >
          ...
          <span class="ml-3 text-xl">Creative Ego</span>
        </a>
    ...
    <div class="bg-gray-200">
      <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col md:flex-row">
        <p class="text-gray-900 text-sm text-center md:text-left">
          © 2020 Creative Ego — 或其合作夥伴。保留所有權利。
        </p>
        <span class="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center dm:justify-start">
